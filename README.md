...
- 고정 링크(최신본):
  - 인덱스: https://myungjoo.github.io/EnergyTop/latest/
  - x64 설치 스크립트: https://myungjoo.github.io/EnergyTop/latest/energytop-installer-x64.sh
  - arm64 설치 스크립트: https://myungjoo.github.io/EnergyTop/latest/energytop-installer-arm64.sh
  - x64 바이너리 아카이브: https://myungjoo.github.io/EnergyTop/latest/energytop-x64.tar.gz
  - arm64 바이너리 아카이브: https://myungjoo.github.io/EnergyTop/latest/energytop-arm64.tar.gz
  - x64 바이너리(직접): https://myungjoo.github.io/EnergyTop/latest/x64/energytop, https://myungjoo.github.io/EnergyTop/latest/x64/energytopd
  - arm64 바이너리(직접): https://myungjoo.github.io/EnergyTop/latest/arm64/energytop, https://myungjoo.github.io/EnergyTop/latest/arm64/energytopd
  - 체크섬: https://myungjoo.github.io/EnergyTop/latest/SHA256SUMS

설치 스크립트 사용 예시:

```bash
curl -fL -o energytop-installer-x64.sh \
  https://myungjoo.github.io/EnergyTop/latest/energytop-installer-x64.sh
