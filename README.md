...
- 고정 링크(최신본):
  - 릴리즈 페이지: https://github.com/myungjoo/EnergyTop/releases/tag/latest-build
  - x64 설치 스크립트: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-installer-x64.sh
  - arm64 설치 스크립트: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-installer-arm64.sh
  - Android x64 설치 스크립트: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-installer-android-x64.sh
  - Android arm64 설치 스크립트: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-installer-android-arm64.sh
  - x64 바이너리 아카이브: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-x64.tar.gz
  - arm64 바이너리 아카이브: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-arm64.tar.gz
  - Android x64 바이너리 아카이브: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-android-x64.tar.gz
  - Android arm64 바이너리 아카이브: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-android-arm64.tar.gz
  - x64 바이너리(직접): https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-x64, https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytopd-x64
  - arm64 바이너리(직접): https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-arm64, https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytopd-arm64
  - Android x64 바이너리(직접): https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-android-x64, https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytopd-android-x64
  - Android arm64 바이너리(직접): https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytop-android-arm64, https://github.com/myungjoo/EnergyTop/releases/download/latest-build/energytopd-android-arm64
  - 체크섬: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/SHA256SUMS
  - 메타데이터: https://github.com/myungjoo/EnergyTop/releases/download/latest-build/metadata.json
